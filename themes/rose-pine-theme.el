...
(autothemer-deftheme
 ...
 (
  ...
  ;; dashboard
  (dashboard-items-face								(:weight 'light :height 110))
  (dashboard-banner-logo-title						(:weight 'thin :height 100))
  (dashboard-heading								(:foreground subtle :weight 'thin :height 110))
