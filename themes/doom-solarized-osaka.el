;;; doom-solarized-osaka.el --- a high-contrast variant of Solarized Dark -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(def-doom-theme doom-solarized-osaka
 ...
 ;; name        default   256       16
  ((bg         '("#001a1d" "#001a1d" "black"      ))
   ...
   ;; custom categories
   (-modeline-bright doom-solarized-osaka-brighter-modeline)
   (-modeline-pad
    (when doom-solarized-osaka-padded-modeline
      (if (integerp doom-solarized-osaka-padded-modeline) doom-solarized-osaka-padded-modeline 4)))
  ...
  (((font-lock-comment-face &override)
    :slant 'italic
    :background (if doom-solarized-osaka-brighter-comments
...
;;; doom-solarized-osaka.el ends here
